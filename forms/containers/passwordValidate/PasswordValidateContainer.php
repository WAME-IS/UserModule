...
interface IPasswordValidateContainerFactory extends IBaseContainer
{
	/** @return PasswordValidateContainer */
	public function create();
}


class PasswordValidateContainer extends BaseContainer
{
    /** {@inheritDoc} */
