...
interface ISignInFormComponentFactory
{
...
class SignInFormComponent implements IComponent
{   
    /** @var LinkGenerator */
    ...
    {
        return $this->linkGenerator->link('Admin:SignInFormComponent:create');
    }


    public function getLinkDetail($componentEntity)
    {
        return $this->linkGenerator->link('Admin:SignInFormComponent:edit', ['id' => $componentEntity->id]);
    }
